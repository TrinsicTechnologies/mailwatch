...
if(USE_LDAP == 1){
	if (($result = ldap_authenticate($myusername, $mypassword)) != NULL) {
...
switch ($usertype){
	...
	case "U":
		...
		$filter1 = implode("' OR to_address='",$user_filter);
	
		$global_filter ="to_address='$filter1'";
		$global_list = "to_address='$filter1'";
		break;
}
